(define (problem drone_problem_d2_r2_l6_p6_c6_g6_ct2)
  ...
  (:init
	...
	(= (fly-cost deposito loc1) 208)
	(= (fly-cost deposito loc2) 79)
	(= (fly-cost deposito loc3) 194)
	(= (fly-cost deposito loc4) 143)
	(= (fly-cost deposito loc5) 59)
	(= (fly-cost deposito loc6) 76)
	(= (fly-cost loc1 deposito) 208)
	(= (fly-cost loc1 loc2) 138)
	(= (fly-cost loc1 loc3) 222)
	(= (fly-cost loc1 loc4) 89)
	(= (fly-cost loc1 loc5) 186)
	(= (fly-cost loc1 loc6) 135)
	(= (fly-cost loc2 deposito) 79)
	(= (fly-cost loc2 loc1) 138)
	(= (fly-cost loc2 loc3) 150)
	(= (fly-cost loc2 loc4) 65)
	(= (fly-cost loc2 loc5) 50)
	(= (fly-cost loc2 loc6) 14)
	(= (fly-cost loc3 deposito) 194)
	(= (fly-cost loc3 loc1) 222)
	(= (fly-cost loc3 loc2) 150)
	(= (fly-cost loc3 loc4) 141)
	(= (fly-cost loc3 loc5) 136)
	(= (fly-cost loc3 loc6) 163)
	(= (fly-cost loc4 deposito) 143)
	(= (fly-cost loc4 loc1) 89)
	(= (fly-cost loc4 loc2) 65)
	(= (fly-cost loc4 loc3) 141)
	(= (fly-cost loc4 loc5) 105)
	(= (fly-cost loc4 loc6) 70)
	(= (fly-cost loc5 deposito) 59)
	(= (fly-cost loc5 loc1) 186)
	(= (fly-cost loc5 loc2) 50)
	(= (fly-cost loc5 loc3) 136)
	(= (fly-cost loc5 loc4) 105)
	(= (fly-cost loc5 loc6) 57)
	(= (fly-cost loc6 deposito) 76)
	(= (fly-cost loc6 loc1) 135)
	(= (fly-cost loc6 loc2) 14)
	(= (fly-cost loc6 loc3) 163)
	(= (fly-cost loc6 loc4) 70)
