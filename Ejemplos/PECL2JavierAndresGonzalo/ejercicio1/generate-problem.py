...
def main():
    ...
    with open(problem_name, 'w') as f:
        ...
        f.write("(defproblem problem ejercicio1\n")
        ...
        for x in drone:
            f.write("\t\t(loc " + x + " deposito)\n")
            f.write("\t\t(brazo1-libre " + x + ")\n")
            f.write("\t\t(brazo2-libre " + x + ")\n")

        for x in crate:
            f.write("\t\t(loc " + x + " deposito)\n")

        for x in range(len(content_types)):
            for y in crates_with_contents[x]:
                f.write("\t\t(contenido-caja " + y + " " + content_types[x] + ")\n")
            
        for x in person:
            f.write("\t\t(loc " + x + " " + random.choice(location[1:]) + ")\n")
        ...
        for x in range(options.persons):
            for y in range(len(content_types)):
                if need[x][y]:
                    ...
                    f.write("\t\t(persona-necesita " + person_name + " " + content_name + ")\n")
